...
void GLFunctions::glTexImage2DArray(int width, int height, int layers, glConst layout, glConst pixelType, void const * data)
{
  ASSERT_EQUAL(CurrentApiVersion, dp::ApiVersion::OpenGLES3, ());
  int const internalFormat = TextureInternalFormatByLayout(layout, pixelType);
...
void GLFunctions::glTexSubImage2DArray(int x, int y, int layer, int width, int height, glConst layout, glConst pixelType,
                                       void const * data)
{
  ASSERT_EQUAL(CurrentApiVersion, dp::ApiVersion::OpenGLES3, ());
